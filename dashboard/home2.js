...
function renderCombinedHourlyChart() {
    ...
    avgHourlyChart = destroyChart(avgHourlyChart);
    ...
    avgHourlyChart = new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                ...
                title: {
                    display: false,
                    text: 'Hourly Call Volume: Average vs Today',
...
function renderAgentVsSystemHourlyChart(agent) {
    ...
    const ctx = document.getElementById('agentVsSystemHourlyCanvas').getContext('2d');
    agentVsSystemHourlyChart = destroyChart(agentVsSystemHourlyChart);

    agentVsSystemHourlyChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: Array.from({length: 24}, (_, i) => `${i}:00`),
            datasets: [
